...
public class FriendsListAdapter2 extends RecyclerView.Adapter<FriendsListAdapter2.ViewHolder> implements Filterable {

    private List<Friend2> original_items = new ArrayList<>();
    private List<Friend2> filtered_items = new ArrayList<>();
    ...
    public FriendsListAdapter2(Context context, List<Friend2> items) {
    ...
    @Override
    public FriendsListAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
    ...
    public Friend2 getItem(int position) {
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Friend2> list = original_items;
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<Friend2>) results.values;
