...
public class FeedUserListAdapter extends RecyclerView.Adapter<FeedUserListAdapter.ViewHolder> {
    ...
    public FeedUserListAdapter(Context ctx, List<FeedUser> items) {
        this.ctx = ctx;
        this.items = items;
    }

    @Override
    public FeedUserListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (p.getPosts().get(position).getPost_type().equals("photo")) {
            Log.e("type", p.getPosts().get(position).getPost_type());
